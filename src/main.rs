...
struct TodoItem {
    ...
    fn main() {
        ...
        loop {
            ...
            match choice {
                1=> {
                    println!("Enter new title of the new item:");
                ...
                3=> {
                    println!("Enter ID of the completed items:");
                    let mut id = String::new();
                    io::stdin().read_line(&mut id).expect("Failed to read line.");
                    let _id: u64 = match id.trim().parse() {
                        Ok(num) => num,
                        Err(_) => continue,
                    };
                ...
                _ => {
                    println!("Invalid choice. Please enter a right number between 1 and 4.");
                }
            }
        }
